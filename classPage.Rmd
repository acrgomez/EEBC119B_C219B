...
My office hours are in TLSB 4000, tentatively Mondays 2:00 to 3:00pm. You can also schedule an appointment by email (acrgomez@ucla.edu).
...
[Install R Studio](https://www.rstudio.com/). R Studio is a free GUI (Graphical User Interface) for the R language that keeps things organized on your screen. You can use R without R Studio, but I do not recommend it.
